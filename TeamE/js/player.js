...
if (isAndroid()) {
$('.minh-100').css('min-height', screen.height);
} else {
$('.minh-100').css('min-height', $(window).height());
}
}
...
var recoveryData;
if (lbLocalStorage) {
recoveryData = lbLocalStorage.getItem("033832a50142edeb5b8008cad4cdbcbbfc3436ea_recovery_data");
}
...
for (let _i = 0; _i < _cfg.questions.length; _i++) {
const _q = _cfg.questions[_i];
for (let _j in _q.question_tag) {
if (_j == _q.iid) {
tempSecTag[_j] = [];
tempQuesTag[_j] = [];
for (let _k = 0; _k < _q.section_tag.length; _k++) {
tempSecTag[_j][_k] = [];
tempSecTag[_j][_k] = _q.section_tag[_k];
}
for (let _k = 0; _k < _q.question_tag[_j].length; _k++) {
tempQuesTag[_j][_k] = [];
tempQuesTag[_j][_k] = _q.question_tag[_j][_k];
}
}
}
}
...
isSuspendable() ? '学習を中断します。本当に移動しますか？' : '学習を終了します。本当に移動しますか？'
);
...
if (lbLocalStorage) {
try {
lbLocalStorage.setItem("033832a50142edeb5b8008cad4cdbcbbfc3436ea_recovery_data", generate_suspend_data(true));
} catch (e) {
...
if (localStorage) localStorage.removeItem("033832a50142edeb5b8008cad4cdbcbbfc3436ea_recovery_data");
...
var seed = '033832a50142edeb5b8008cad4cdbcbbfc3436ea';
this.dummy = true;
...
if (localStorage) {
localStorage.removeItem("033832a50142edeb5b8008cad4cdbcbbfc3436ea_recovery_data");
}
});
